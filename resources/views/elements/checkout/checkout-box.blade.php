                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <div class="d-flex text-left radio-group row">
                                ...
                                @endif
                                <div class="p-0 col-6 col-md-3" {!! !Auth::check() || Auth::user()->wallet->total <= 0 ? 'data-toggle="tooltip" data-placement="right"' : '' !!} title="{{__('You can use the wallet deposit page to add credit.')}}">
